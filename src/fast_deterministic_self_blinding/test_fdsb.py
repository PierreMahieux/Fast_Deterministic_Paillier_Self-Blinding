...
import fdsb
from .utils import mesh_utils, util, paillier
...
if __name__ == "__main__":
    ...
    config = {"key_size": KEY_SIZE, "quantisation_step": QUANTISATION_STEP, "qim_step": QIM_STEP, "result_folder": result_folder, "model_path": model_path, "model_name": model_name, }
